...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    switch (strtolower($recurso)) {
        case '':
            ...
            echo json_encode(CtrCertificacionesVsa::findByIdInfo($router->param('id_certificacion')));
            return;
            break;
        ...
        case 'lista':
            header("Content-Type: application/json; charset=UTF-8");
            http_response_code(200);
            echo json_encode(CtrCertificacionesVsa::findAll($router->param('id_solicitud'), $router->param('id_servicio')));
            return;
            break;
    ...
    switch (strtolower($recurso)) {
        case 'delete_info':
            ...
            http_response_code(200);
            echo json_encode(
                CtrCertificacionesVsa::delete(
                    $router->param('id_certificacion'),
                )
            );
            return;
            break;
