...
class CtrPreguntaProDrogasPolPre
{

    public static function crear($id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro)
    {
        ...
        $obj_caracteristicaVariable = new preguntaProDrogasPolPre();
    ...
    public static function update($id_preg_pro_drogas_pol, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro)
    {
        if (!isset($id_preg_pro_drogas_pol) || $id_preg_pro_drogas_pol == "")
            return Result::error(__FUNCTION__, "id id_preg_pro_drogas_pol es requerido");


        $dao = new preguntaProDrogasPolPre($id_preg_pro_drogas_pol);
    ...
    public static function produccioDrogasPolPreById($id_solicitud, $id_servicio)
    {
        ...
        $result = QuerySQL::select(
            <<<SQL
                select o.id_preg_pro_drogas_pol, 
                        o.id_solicitud, 
                        o.id_servicio, 
                        o.pregunta_uno,
                        o.pregunta_dos,
                        o.pregunta_tres,
                        o.pregunta_cuatro
                    from preguntas_pro_drogas_pol_pre o 
