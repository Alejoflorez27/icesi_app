...
class CtrPreguntaMarihuanaPolPre
{

    public static function crear($id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro, $pregunta_cinco, $pregunta_seis)
    {
        ...
        $obj_caracteristicaVariable = new preguntaMarihuanaPolPre();
    ...
    public static function update($id_preg_marihuana_pol, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro, $pregunta_cinco, $pregunta_seis)
    {
        if (!isset($id_preg_marihuana_pol) || $id_preg_marihuana_pol == "")
            return Result::error(__FUNCTION__, "id id_preg_marihuana_pol es requerido");


        $dao = new preguntaMarihuanaPolPre($id_preg_marihuana_pol);
    ...
    public static function alcoholPolPreById($id_solicitud, $id_servicio)
    {
        ...
        $result = QuerySQL::select(
            <<<SQL
                select o.id_preg_marihuana_pol, 
                        o.id_solicitud, 
                        o.id_servicio, 
                        o.pregunta_uno,
                        o.pregunta_dos,
                        ...
                        o.pregunta_cinco,
                        o.pregunta_seis
                    from preguntas_marihuana_pol_pre o 
        ...
        return Result::success($result, "buscar preguntas de Marihuana");
