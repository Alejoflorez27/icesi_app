...
class CtrPreguntaInfoFalsaPolPre
{

    public static function crear($id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $item_poligrafia, $admitio, $resumen)
    {
        ...
        $obj_caracteristicaVariable = new preguntaInfoFalsaPolPre();
    ...
    public static function update($id_preg_pers_ilegales_pol, $pregunta_uno, $pregunta_dos, $id_solicitud,$id_servicio, $item_poligrafia, $admitio, $resumen)
    {
        ...
        $dao = new preguntaInfoFalsaPolPre($id_preg_pers_ilegales_pol);
    ...
    public static function infoFalsaPolPreById($id_solicitud, $id_servicio)
    {
        if (!isset($id_solicitud) || $id_solicitud == "")
        ...
        $result = QuerySQL::select(
            <<<SQL
                select o.id_preg_info_falsa_pol, 
                        o.id_solicitud, 
                        o.id_servicio, 
                        o.pregunta_uno,
                        o.pregunta_dos
                    from preguntas_info_falsa_pol_pre o 
