...
class CtrPreguntaPersIlegalesPolPre
{
    ...
    public static function crear($id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro, $pregunta_cinco, $item_poligrafia, $admitio, $resumen)
    {
        ...
        $obj_caracteristicaVariable = new preguntaPersIlegalesPolPre();
    ...
    public static function update($id_preg_pers_ilegales_pol,$id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro, $pregunta_cinco, $item_poligrafia, $admitio, $resumen)
    {
        if (!isset($id_preg_pers_ilegales_pol) || $id_preg_pers_ilegales_pol == "")
            return Result::error(__FUNCTION__, "id id_preg_pro_drogas_pol es requerido");


        $dao = new preguntaPersIlegalesPolPre($id_preg_pers_ilegales_pol);
    ...
    public static function personasIlegalesPolPreById($id_solicitud, $id_servicio)
    {
        if (!isset($id_solicitud) || $id_solicitud == "")
        ...
        $result = QuerySQL::select(
            <<<SQL
                select o.id_preg_pers_ilegales_pol, 
                        o.id_solicitud, 
                        o.id_servicio, 
                        o.pregunta_uno,
                        o.pregunta_dos,
                        ...
                        o.pregunta_cuatro,
                        o.pregunta_cinco
                    from preguntas_pers_ilegales_pol_pre o 
