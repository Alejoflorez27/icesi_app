...
class CtrPreguntaIlicitoPolRutina
{
    ...
    public static function crear($id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $pregunta_tres)
    {
        ...
        $obj_caracteristicaVariable = new preguntaIlicitoPolRutina();
    ...
    public static function update($id_preg_ilicito_pol, $pregunta_uno, $pregunta_dos, $pregunta_tres)
    {
        if (!isset($id_preg_ilicito_pol) || $id_preg_ilicito_pol == "")
            return Result::error(__FUNCTION__, "id id_preg_ilicito_pol es requerido");


        $dao = new preguntaIlicitoPolRutina($id_preg_ilicito_pol);
    ...
    public static function ilicitosPolRutinaById($id_solicitud, $id_servicio)
    {
        if (!isset($id_solicitud) || $id_solicitud == "")
        ...
        $result = QuerySQL::select(
            <<<SQL
                select o.id_preg_ilicito_pol, 
                        o.id_solicitud, 
                        o.id_servicio, 
                        o.pregunta_uno,
                        o.pregunta_dos,
                        o.pregunta_tres
                    from preguntas_ilicitos_pol_rutina o 
        ...
        return Result::success($result, "buscar los ilicitos de poligrafia rutina");
