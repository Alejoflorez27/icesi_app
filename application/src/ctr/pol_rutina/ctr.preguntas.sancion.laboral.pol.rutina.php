...
class CtrPreguntaSancionLaboralPolRutina
{

    public static function crear($id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro, $pregunta_cinco, $item_poligrafia, $admitio, $resumen)
    {
        ...
        $obj_caracteristicaVariable = new PreguntaSancionLaboralPolRutina();
    ...
    public static function update($id_preg_sancion_pol, $id_solicitud, $id_servicio, $pregunta_uno, $pregunta_dos, $pregunta_tres, $pregunta_cuatro, $pregunta_cinco, $item_poligrafia, $admitio, $resumen)
    {
        if (!isset($id_preg_sancion_pol) || $id_preg_sancion_pol == "")
            return Result::error(__FUNCTION__, "id id_preg_sancion_pol es requerido");


        $dao = new PreguntaSancionLaboralPolRutina($id_preg_sancion_pol);
    ...
    public static function sancionPolRutinaById($id_solicitud, $id_servicio)
    {
        if (!isset($id_solicitud) || $id_solicitud == "")
        ...
        $result = QuerySQL::select(
            <<<SQL
                select o.id_preg_sancion_pol, 
                        ...
                        o.pregunta_cuatro,
                        o.pregunta_cinco
                    from preguntas_sancion_laboral_pol_rutina o 
        ...
        return Result::success($result, "buscar las sanciones de poligrafia rutina");
