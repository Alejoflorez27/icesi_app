<?php 
/**
 * Vista: Gestión Curricular - Página integrada con el sistema
 * Ubicación: application/app/view/curriculoGestion.php
 */
?>
        ...
        <div class="card">
            <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="tab-cursos-link" href="#tab-cursos" data-toggle="pill" role="tab">
                            <i class="fas fa-book"></i> Cursos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tab-competencias-link" href="#tab-competencias" data-toggle="pill" role="tab">
                            <i class="fas fa-star"></i> Competencias
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tab-objetivos-link" href="#tab-objetivos" data-toggle="pill" role="tab">
                            <i class="fas fa-target"></i> Objetivos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tab-analisis-link" href="#tab-analisis" data-toggle="pill" role="tab">
            ...
            <div class="card-body">
                <div class="tab-content">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button class="btn btn-primary btn-sm" onclick="mostrarModalCurso()">
                    ...
                    <!-- TAB: COMPETENCIAS -->
                    <div class="tab-pane fade" id="tab-competencias" role="tabpanel">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Gestión de Competencias</h3>
                                <div class="card-tools">
                                    <button class="btn btn-primary btn-sm" onclick="mostrarModalCompetencia()">
                    ...
                    <div class="tab-pane fade" id="tab-objetivos" role="tabpanel">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button class="btn btn-primary btn-sm" onclick="mostrarModalObjetivo()">
                    ...
                    <div class="tab-pane fade" id="tab-analisis" role="tabpanel">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Objetivos sin Asignar</h3>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Competencias sin Objetivos</h3>
                                    </div>
                                    <div class="card-body">
            ...
            <div class="modal-body">
                <form id="formCurso">
                    ...
                    <div class="form-group">
                        ...
                        <select id="curso-programa" class="form-control" required></select>
                    </div>
                    <div class="form-group">
                        <label>Nombre</label>
...
<div class="modal fade" id="modalCompetencia" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Gestionar Competencia</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formCompetencia">
                    ...
                    <div class="form-group">
                        <label>Descripción</label>
                        <textarea id="competencia-descripcion" class="form-control" rows="4"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="modalObjetivo" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Gestionar Objetivo</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formObjetivo">
                    ...
                    <div class="form-group">
                        ...
                        <select id="objetivo-competencia" class="form-control" required></select>
                    </div>
                    <div class="form-group">
                        <label>Nombre</label>
                    ...
                    <div class="form-group">
                        <label>Descripción</label>
                        <textarea id="objetivo-descripcion" class="form-control" rows="4"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
