...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="solicitud/detalle?solicitud=<?= $solicitud['id_solicitud'] ?>"><i class="fa fa-dashboard"></i> Información Laboral</a></li>
        <li class="active">Brechas de inactividad laboral</li>
    </ol>
</section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="col-xs-6 col-sm-12 center-block">
                            <h4 class="box-title">8. BRECHAS O INACTIVIDAD LABORAL</h4>
                        </div>
            ...
            <form id="formBrechas" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-9 center-block">
                                <p>1. Se encontrarón en la historia laboral del evaluado, brechas o tiempos laborales de inactividad superiores a 2 meses (Si la respuesta es SI, escriba en la casillas que se activaran, cuáles fueron las brechas o periodos de inactividad encontrados, los tiempos aproximados y las fechas aproximadas?</p>
                            </div>
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <select class="form-control input select2" id="periodo" name="periodo" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <select class="form-control input select2" id="tmp_periodo" name="tmp_periodo" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<?php include 'vw.brechas_laboral_ec_sin_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/brechas_laboral_ec_sin_cifin.js"></script>
