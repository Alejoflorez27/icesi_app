...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Cargue Adjuntos Estudio de Confidencialidad sin Cifin</li>
    </ol>
</section>
...
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/adjuntos_ec_sin_cifin.js"></script>
