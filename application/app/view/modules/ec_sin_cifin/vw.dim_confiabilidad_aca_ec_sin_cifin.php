...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Dimensión Academico</li>
    </ol>
</section>
...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">6. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD DE INFORMACIÓN, DOCUMENTACIÓN Y ANTECEDENTES ACADÉMICOS </h4>
            </div>
    ...
    <form id="formDimensionAcademico" role="form" method="post" enctype="multipart/form-data" autocomplete="off">

                <input type="hidden" id="accion" name="accion" value="">
                <input type="hidden" id="id_respuesta" name="id_respuesta" value="">
                <input type="hidden" id="id_dimension" name="id_dimension" value="13">                
            ...
            <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="small-box bg-aqua text-center">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada la información del evaluado es totalmente confiable y se ajusta completamente a la realidad. (Ajuste entre un 95% y 100%) 
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada la información del evaluado es confiable y se ajusta en su gran mayoría a la realidad. (Ajuste entre 90% y 95%) 
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada la información del evaluado es medianamente confiable y se ajusta en medio nivel a la realidad. (Ajuste entre 80% y 90%)
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada la información del evaluado es poco confiable y se ajusta poco a la realidad. (Ajuste entre 70% y 80%)
                                    </p>
                                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="variableAcademico" class="control-label">Variable a Analizar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
								<select class="form-control input select2" id="variableAcademico" name="variableAcademico" placeholder="variables" required>
                                </select>
                            </div>
                        </div>
                    </div>
...
*Rol del evaluado: único proveedor, puede ser un riesgo, que puede llevarlo a actos de robo. Como lo reconocen en su núcleo familiar. En la visita debe estar un familiar.</textarea>
                    ...
                    <div class="modal-footer">
                        <button id="btn-submit-dimensionAcademico" type="submit" class="btn btn-primary btnAddDimensionAcademico">Guardar</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
                ...
                <div class="box-body">
                    ...
                    <table id="tbl-academicoDimension" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                <th>Id</th>
...
<?php include 'vw.dim_confiabilidad_aca_ec_sin_cifin.modal.php' ?>
<?php include 'vw.plantilla_var_ec_sin_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/dim_confiabilidad_aca_ec_sin_cifin.js"></script>
