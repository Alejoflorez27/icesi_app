...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="solicitud/detalle?solicitud=<?= $solicitud['id_solicitud'] ?>"><i class="fa fa-dashboard"></i> Evaluación Financiera</a></li>
...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">5.INFORMACIÓN, DOCUMENTACIÓN Y ANTECEDENTES ACADÉMICOS</h4>
            </div>
    ...
    <form id="formFormacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="nom_funcionario" class="control-label"> Nombre del funcionario que verifica la información: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="tel_funcionario" class="control-label"> Teléfono del funcionario que verifica la información: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                    ...
                    <table id="tbl-formacion" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Acta y Folio</th>
                                <th>Nombre del funcionario que verifica la información</th>
                                <th>Teléfono del funcionario que verifica la información</th>
...
<?php include 'vw.formacion_ec_sin_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/formacion_ec_sin_cifin.js"></script>
