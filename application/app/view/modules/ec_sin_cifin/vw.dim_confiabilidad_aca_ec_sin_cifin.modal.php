...
<div id="modalAddDimensionAcademico" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            <form id="formDimensionAcademicoedit" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-dimensionFamilia">6. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD DE INFORMACIÓN, DOCUMENTACIÓN Y ANTECEDENTES ACADÉMICOS</h4>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
								...
								<select class="form-control input select2" id="variableAcademicoEdit" name="variableAcademicoEdit" required>
                                </select>
                            </div>
                        </div>
                    </div>
