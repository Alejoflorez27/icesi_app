...
<?php include 'vw.obs_adicional_ec_sin_cifin.modal.php' ?>
<?php include 'vw.observacion__ec_sin_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/obs_adicional_ec_sin_cifin.js"></script>
