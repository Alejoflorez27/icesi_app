...
<?php include 'vw.dim_confiabilidad_laboral_ec_sin_cifin.modal.php' ?>
<?php include 'vw.plantilla_var_ec_sin_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/dim_confiabilidad_laboral_ec_sin_cifin.js"></script>
