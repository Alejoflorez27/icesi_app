...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="solicitud/detalle?solicitud=<?= $solicitud['id_solicitud'] ?>"><i class="fa fa-dashboard"></i> Confiabilidad Financiera</a></li>
        <li class="active">Evaluación Financiera</li>
    </ol>
</section>
...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">4. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD FINANCIERA/CIFIN - CRÉDITOS Y OBLIGACIONES FINANCIERAS</h4>
            </div>
    ...
    <form id="formDimensionFamilia" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" id="id_dimension" name="id_dimension" value="12">
            ...
            <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="small-box bg-aqua text-center">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada sobre los compromisos y créditos financieros del evaluado, evidencia que el evaluado es totalmente confiable en el cumplimiento de sus obligaciones y créditos financieros.
A. Cumplimiento en pagos entre 90% a 100%.
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada sobre los compromisos y créditos financieros del evaluado, evidencia que el evaluado es confiable en el cumplimiento de sus obligaciones y créditos financieros.
A. Cumplimiento en pagos entre 80% a 90%. 
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada sobre los compromisos y créditos financieros del evaluado, evidencia que el evaluado es medianamente confiable en el cumplimiento de sus obligaciones y créditos financieros.
A. Cumplimiento en pagos entre 70% a 80%. 
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada sobre los compromisos y créditos financieros del evaluado, evidencia que el evaluado es poco confiable en el cumplimiento de sus obligaciones y créditos financieros.
A. Cumplimiento en pagos entre 60% a 70%
                                    </p>
                                    </div>
...
<?php include 'vw.dim_confiabilidad_fin_ec_sin_cifin.modal.php' ?>
<?php include 'vw.plantilla_var_ec_sin_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/dim_confiabilidad_fin_ec_sin_cifin.js"></script>
