...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="solicitud/detalle?solicitud=<?= $solicitud['id_solicitud'] ?>"><i class="fa fa-dashboard"></i> Evaluación laboral</a></li>
        <li class="active">Evaluación de actitud y compromiso</li>
    </ol>
</section>
...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">10. EVALUACIÓN DE LA ACTITUD Y COMPROMISO DEL EVALUADO CON EL PROCESO </h4>
            </div>
    ...
    <form id="formDimensionCompromiso" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" id="id_dimension" name="id_dimension" value="15">
...
<?php include 'vw.dim_confiabilidad_compromiso_ec_sin_cifin.modal.php' ?>
<?php include 'vw.plantilla_var_ec_sin_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/dim_confiabilidad_compromiso_ec_sin_cifin.js"></script>
