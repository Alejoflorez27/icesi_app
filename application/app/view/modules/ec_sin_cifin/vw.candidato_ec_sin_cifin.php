        ...
        <div class="col-md-12" id="div-box-clientes">
            ...
            <form id="formVisitaIngreso" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="box-header" id="div-crear">
                        <h3 class="box-title">1.Datos Generales Estudio Confiabilidad Con Cifin</h3>
                ...
                <div class="box-body">
                        ...
                        <div class="col-xs-12 col-sm-3 center-block">
                            <div class="form-group">
                                <label for="nombre" class="control-label">Nombre del evaluado: *</label>
                        ...
                        <div class="col-xs-12 col-sm-3 center-block">
                            <div class="form-group">
                                <label for="apellido" class="control-label">Apellido del evaluado: *</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-font"></i></span>
                        ...
                        <div class="col-xs-12 col-sm-3 center-block">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                    <input type="date" class="form-control" name="fch_nacimiento" id="fch_nacimiento" placeholder="Ingrese la Fecha de Nacimiento" required>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="col-xs-12 col-sm-3 center-block">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                    <input type="number" class="form-control input" name="edad" id="edad" placeholder="Ingrese la Edad" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-3 center-block">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control input" name="libreta" id="libreta" placeholder="Ingrese el Correo del evaluado" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4 center-block">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-hashtag"></i></span>
                                    <input type="number" class="form-control input" name="estracto" id="estracto" placeholder="Ingrese el Estracto del evaluado" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 center-block">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                    <input type="text" class="form-control input" name="referencia_personal" id="referencia_personal" placeholder="Referecia Personal" required>
                                </div>
                            </div>
                        </div> -->
...
<script src="<?= constant('APP_URL') ?>app/js/ec_sin_cifin/candidato_ec_sin_cifin.js"></script>
