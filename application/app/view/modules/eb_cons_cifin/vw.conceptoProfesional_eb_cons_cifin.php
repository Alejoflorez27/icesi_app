            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="concepto_final" class="control-label">Concepto Final Funcionario: *</label>
...
<script src="<?= constant('APP_URL') ?>app/js/eb_cons_cifin/conceptoProfesional_eb_cons_cifin.js"></script>
