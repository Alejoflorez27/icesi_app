...
<?php include 'vw.dim_confiabilidad_fin_eb_cons_cifin.modal.php' ?>
<?php include 'vw.plantilla_var_eb_cons_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/eb_cons_cifin/dim_confiabilidad_fin_eb_cons_cifin.js"></script>
