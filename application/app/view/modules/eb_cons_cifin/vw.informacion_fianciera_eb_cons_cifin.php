...
<?php include 'vw.informacion_fianciera_eb_cons_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/eb_cons_cifin/informacion_financiera_eb_cons_cifin.js"></script>
