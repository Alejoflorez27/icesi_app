        ...
        <div class="col-md-12" id="div-box-clientes">
            ...
            <form id="formVisitaIngreso" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="box-header" id="div-crear">
                        <h3 class="box-title">1.Datos Generales Estudio Basico Cifin</h3>
                        ...
                        <div class="col-xs-12 col-sm-3 center-block">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input" name="libreta" id="libreta" placeholder="Ingrese el Correo del evaluado" required>
                                </div>
                            </div>
                        </div>
...
<script src="<?= constant('APP_URL') ?>app/js/eb_cons_cifin/candidato_eb_cons_cifin.js"></script>
