...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">7.Cargue Adjuntos Estudio de Confidencialidad con Cifin</h4>
            </div>
...
<script src="<?= constant('APP_URL') ?>app/js/eb_cons_cifin/adjuntos_eb_cons_cifin.js"></script>
