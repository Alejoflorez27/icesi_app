...
<?php include 'vw.obs_adicional_eb_cons_cifin.modal.php' ?>
<?php include 'vw.observacion_eb_cons_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/eb_cons_cifin/obs_adicional_eb_cons_cifin.js"></script>
