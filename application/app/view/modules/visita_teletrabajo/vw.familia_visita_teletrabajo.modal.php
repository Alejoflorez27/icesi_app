        ...
        <div class="modal-content">
            <form id="formFamilia" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-body">
                 ...
                 <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="horario_edit" class="control-label">Horario de permanencia en el hogar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <input type="text" class="form-control input" id="horario_edit" name="horario_edit" placeholder="Ingresar horarrio (00:00 am - 00:00 pm)" required>
                                </input>
                            </div>
                        </div>
                    </div>
