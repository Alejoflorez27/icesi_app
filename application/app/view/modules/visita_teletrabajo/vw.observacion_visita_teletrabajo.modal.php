                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="observacion" class="control-label">Distribución de los roles y compromisos al interior de la familia  para que el Evaluado pueda Teletrabajar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <textarea class="form-control input" style="height: 120px;" id="observacion" name="observacion" placeholder="Realizar las aclaraciones del cuadro familiar en estes espacio, en caso de ser necesarios"></textarea>
                            </div>
                        </div>
                    </div>                
