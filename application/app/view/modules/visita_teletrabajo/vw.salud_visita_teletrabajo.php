    ...
    <div class="col-xs-6 col-sm-12 center-block">
        ...
        <div class="box box-primary">
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 center-block">
                        <h4 class="box-title">8. ASPECTOS DE SALUD</h4>
                    </div>
            ...
            <form id="formSaludTeletrabajo" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <input type="hidden" id="id_salud" name="id_salud" value="">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="aspecto" class="control-label">Aspecto Salud: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <select class="form-control input select2" id="aspecto" name="aspecto" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button id="btn-submit-salud" type="submit" class="btn btn-primary btnAddSalud">Guardar</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.box-body -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            ...
                            <table id="tbl-salud" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Aspectos de Salud</th>
                                        <th>Observación</th>
                                        <th>Acciones</th>
                                    </tr>
                                </thead>
...
<?php include 'vw.salud_visita_teletrabajo.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_teletrabajo/salud_visita_teletrabajo.js"></script>
