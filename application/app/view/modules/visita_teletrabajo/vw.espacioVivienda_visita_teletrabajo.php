        ...
        <div class="box box-primary">
            ...
            <form id="formVivDistribucion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block" id="ocultarCantidad">
                                <div class="form-group">
                                    <label for="numero_espacio" class="control-label">Cantidad :*</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block" id="ocultarOcupante">
                                <div class="form-group">
                                    <label for="ocupante" class="control-label">Ocupante : *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <input type="text" class="form-control input" id="ocupante" name="ocupante" required></input>
                                    </div>
                                </div>
                            </div>

                            <!-- ENTRADA PARA TIPO DESCRIPCION -->
                            <div class="col-xs-12 col-sm-12 center-block" id="ocultarDescripcion">
                                <div class="form-group">
...
<?php include 'vw.espacioVivienda_visita_teletrabajo.modal.php' ?>
...
<script src="<?= constant('APP_URL') ?>app/js/visita_teletrabajo/espacios_vivienda_visita_teletrabajo.js"></script>
