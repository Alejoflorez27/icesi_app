            ...
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 center-block">
                        <h4 class="box-title">6. Factores de riesgo</h4>
                    </div>
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="factor" class="control-label">Factor de Riesgo: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <select class="form-control input select2" id="factor" name="factor" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="aspecto" class="control-label">Aspecto Identicado: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <input class="form-control input" id="aspecto" name="aspecto" readonly>
                                        </input>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <select class="form-control input" id="descripcion" name="descripcion" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="descripcion_com" class="control-label">Descripción completa: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <textarea class="form-control input" id="descripcion_com" name="descripcion_com" readonly></textarea>
                                    </div>
                                </div>
                            </div>
...
<?php include 'vw.factores_riesgo_visita_teletrabajo.modal.php' ?>

<script src="<?= constant('APP_URL') ?>app/js/visita_teletrabajo/factores_riesgo_visita_teletrabajo.js"></script>
