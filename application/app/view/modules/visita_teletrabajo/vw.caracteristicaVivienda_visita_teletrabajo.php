    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">4. DESCRIPCIÓN DE LUGAR DE RESIDENCIA</h4>
            </div>
            ...
            <button class="btn btn-primary btnAddCaracterisiticaViv" data-toggle="modal" data-target="#modalAddVivCaracteristica">
                Crear
            </button>
        </div>
    </div>
                ...
                <div class="box-body">
                    <table id="tbl-vivCaracteristica" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Forma de propiedad</th>
                                <th>Tamaño aproximado</th>
                                <th>Organización y limpieza</th>
                                <th>Descripción de la seguridad del sector y de la residencia</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                    </table>
...
<?php include 'vw.caracteristicaVivienda_visita_teletrabajo.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_teletrabajo/caracteristicas_vivienda_teletrabajo.js"></script> 