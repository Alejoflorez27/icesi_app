      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover" id="tabla-distribucion">
              ...
              <tbody>
                <tr>
                  <td><select class="form-control form-control-sm tipo-espacio" id="tipo_espacio_inicial"></select></td>
                  <td><input type="number" class="form-control form-control-sm cant-espacios" value="1" min="1"></td>
                  <td><select class="form-control form-control-sm estado-espacio" id="estado_espacio_inicial"></select></td>
                  <td><select class="form-control form-control-sm dotacion" id="dotacion_mobiliaria_inicial"></select></td>
                  <td><input type="number" class="form-control form-control-sm cant-mobiliario" value="1" min="0"></td>
                  <td><select class="form-control form-control-sm estado-mobiliario" id="estado_mobiliario_inicial"></select></td>
                  <td><select class="form-control form-control-sm tenencia" id="tenencia_mobiliario_inicial"></select></td>
...
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/distribucion_vivienda_visita_ingresonew.js"></script>
