        ...
        <div class="box-header" id="div-crear">
            <div class="row">
                <div class="col-lg-6 col-xs-6">
                    <h3 class="box-title">18. MATRIZ VALORACION DE RIESGOS DE SALUD DEL EVALUADO Y SU FAMILIA</h3>
                </div>
                <div class="col-lg-6 col-xs-6">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua text-center">
                        ...
                        <p style="font-size: 14px">En la variable analizada el Evaluado evidencia un nivel
                                muy bajo de riesgo en su salud o la de su familia
                        </p>
                        </div>
...
*Que el Evaluado o Evaluado, este a cargo del cuidado de un familia que requiera cuidado permanente y no
cuenten con otra red de apoyo. Para la compra de medicamentos como las sustentan.
*Que el Evaluado o Evaluado admitan el consumo de sustancias psicoactivas.
</textarea>
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.dimensionSalud_visita_ingreso.modal.php' ?>
<?php include 'vw.info_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/dimensionSalud_visita_ingreso.js"></script>
