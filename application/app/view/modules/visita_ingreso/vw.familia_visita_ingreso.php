    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-9 center-block">
                ...
                <h5 class="box-title">(Personas que convieven actualmente con el Evaluado y de origen)</h5>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
                ...
                <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <button class="btn btn-primary pull-left btnAddFamiliaObs" title="Dar Clic para Observación del nucleo Familiar" id="obsFamilia" type="button" data-toggle="modal" data-target="#modalAddObservacion">Observación</button>
...
<?php include 'vw.familia_visita_ingreso.modal.php' ?>
<?php include 'vw.observacion_visita_ingreso.modal.php' ?>
<?php include 'vw.info_ocu_familia_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/familia_visita_ingreso.js"></script>
