            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <select class="form-control input select2" id="estado_electrodomestico" name="estado_electrodomestico" required>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <select class="form-control input select2" id="tenencia_electrodomestico" name="tenencia_electrodomestico" required>
                                </select>
                            </div>
                        </div>
                    </div>
...
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/electrodomestico_vivienda_visita_ingreso.js"></script>
