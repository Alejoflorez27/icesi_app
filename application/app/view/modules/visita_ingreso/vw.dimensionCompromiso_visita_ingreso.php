...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">19.MATRIZ VALORACION DE LA ACTITUD Y COMPROMISO DEL EVALUADO CON EL PROCESO</h4>
            </div>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="small-box bg-aqua text-center">
                        ...
                        <p style="font-size: 14px">En la variable analizada el Evaluado no evidencia riesgo en la actitud y colaboración con la visita
                        </p>
                        </div>
                    ...
                    <div class="inner">
                        ...
                        <p style="font-size: 14px">En la variable analizada el Evaluado evidencia un nivel
                                bajo de riesgo en la actitud y colaboración con la visita
                        </p>
                        </div>
                    ...
                    <div class="inner">
                        ...
                        <p style="font-size: 14px">En la variable analizada el Evaluado evidencia un nivel
                                medio de riesgo en la actitud y colaboración con la visita
                        </p>
                        </div>
                    ...
                    <div class="inner">
                        ...
                        <p style="font-size: 14px">En la variable analizada el Evaluado evidencia un nivel
                                alto de riesgo en la actitud y colaboración con la visita
                        </p>
                        </div>
...
Que el funcionario o Evaluado, muestre poco interés frente al proceso, que no suministre información necesaria
para lograr los objetivos de la visita, que su presentación personal sea inapropiada, que se muestre irrespetuoso con el profesional a cargo.
*Obstaculos para hacer la visita, no tienen total disponibilidad o aplazan la visita, puede ser indicativo que algo esconden.
PROTOCOLO DE SEGURIDAD: Vienen de zonas de alta riesgo o con problemáticas sociales y preguntas de vínculos a procesos de judiciales.
</textarea>
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.dimensionCompromiso_visita_ingreso.modal.php' ?>
<?php include 'vw.plantilla_var_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/dimensionCompromiso_visita_ingreso.js"></script>
