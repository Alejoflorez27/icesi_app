    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">3.FORMACIÓN ACADÉMICA</h4>
            </div>
...
<?php include 'vw.formacion_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/formacion_visita_ingreso.js"></script>
