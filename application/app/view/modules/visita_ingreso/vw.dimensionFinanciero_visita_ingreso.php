    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">17. MATRIZ VALORACIÓN DEL RIESGO FINANCIERO Y ECONÓMICO DEL EVALUADO Y SU FAMILIA</h4>
            </div>
...
<?php include 'vw.dimensionFinanciero_visita_ingreso.modal.php' ?>
<?php include 'vw.plantilla_var_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/dimensionFinanciero_visita_ingreso.js"></script>
