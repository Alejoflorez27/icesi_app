    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">6. CARACTERISTICAS DE LA VIVIENDA</h4>
            </div>
                    ...
                    <table id="tbl-vivCaracteristica" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Aclaraciones de caracteristicas de la vivienda</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                    </table>
...
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/caracteristicas_vivienda_visita_ingreso.js"></script> 