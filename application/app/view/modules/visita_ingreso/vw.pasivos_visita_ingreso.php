...
<div class="row">
            ...
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-12 col-sm-8 center-block">
                        <h4 class="box-title">14. PASIVOS DEL EVALUADO (Y CONYUGUE SI APLICA) </h4>
                    </div>
    ...
    <div  class="col-md-6 col-12">
        <?php include 'vw.activos_visita_ingreso.php' ?>
    </div>
...
<?php include 'vw.pasivos_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/pasivos_visita_ingreso.js"></script>
