...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">5.MATRIZ VALORACIÓN DEL NIVEL DE RIESGO DE LA DIMENSION FAMILIAR DEL EVALUADO</h4>
            </div>
    ...
    <form id="formDimensionFamilia" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" id="id_dimension" name="id_dimension" value="1"> <!-- 1 = Dimension Familiar -->
...
<?php include 'vw.dimensionFamilia_visita_ingreso.modal.php' ?>
<?php include 'vw.plantilla_var_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/dimensionFamilia_visita_ingreso.js"></script>
