        ...
        <div class="modal-content">
            <form id="formVivAnterior" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">10. SITIOS DE VIVIENDA ANTERIORES Y TIEMPO DE ESTADÍA DE ELLOS</h4>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input" name="ubicacion_edit" id="ubicacion_edit" placeholder="Ubicación de la Vivienda" >
                            </div>
                        </div>
                    </div>
