    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">11. MATRIZ VALORACIÓN DEL RIESGO SOCIAL Y HABITACIONAL DEL EVALUADO Y SU FAMILIA</h4>
            </div>
...
*Condiciones de la estructura física de la vivienda que puedan afectar la salud del Evaluado y su familia.
...
*Dificulltades y demora en el desplazamiento del Evaluado a su lugar de trabajo como carencia de vías de acceso
...
* Inseguridad y problemáticas del sector que puedan afectar al Evaluado (a) o funcionario (a). ( Horarios de llegada
...
* Carencia de dotación de la vivienda, no tienen lo mínimo para tener un buen nivel de vida o si tiene en exceso.
...
<?php include 'vw.dimensionSocial_visita_ingreso.modal.php' ?>
<?php include 'vw.plantilla_var_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/dimensionSocial_visita_ingreso.js"></script>
