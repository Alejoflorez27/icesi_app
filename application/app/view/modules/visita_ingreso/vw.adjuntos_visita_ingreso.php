...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">22.Cargue Adjuntos Visita Domiciliaria Ingreso</h4>
                <h5 class="box-title">Las fotos se deben tomar en una misma dirección (vertical u horizontal), ser claras, nítidas y de buena calidad. Se debe tomar con la aplicación de Time Stamp Camera Free, donde se vea la fecha, hora y sitio geográfico. NO se deben tomar fotos de menores de edad, por la Ley de Protección al Menor.</h5>
            </div>
            <div class="col-xs-12 col-sm-4 center-block">
                <button id="btn-submit-Siguiente" type="submit" class="btn btn-success btnSiguiente pull-right">Finalizar</button>
...
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/adjuntos_visita_ingreso.js"></script>
