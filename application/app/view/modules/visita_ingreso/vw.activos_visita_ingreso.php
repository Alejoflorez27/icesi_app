...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">15. ACTIVOS DEL EVALUADO (Y CONYUGUE SI APLICA)</h4>
            </div>
...
<?php include 'vw.activos_visita_ingreso.modal.php' ?>
<?php include 'vw.ayuda_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/activos_visita_ingreso.js"></script>
