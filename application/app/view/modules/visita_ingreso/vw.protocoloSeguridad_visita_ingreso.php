    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-6 center-block">
                <h4 class="box-title">20.PROTOCOLO DE SEGURIDAD /ASPECTOS CRÍTICOS DE RIESGO</h4>
            </div>
            <div class="col-xs-12 col-sm-6 center-block">
...
<?php include 'vw.protocoloSeguridad_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/protocoloSeguridad_visita_ingreso.js"></script>
