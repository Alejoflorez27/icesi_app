...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block" style="position: relative;">
                <h4 class="box-title">10.SITIOS DE VIVIENDA ANTERIORES Y TIEMPO DE ESTADÍA DE ELLOS</h4>
            </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input" name="ubicacion" id="ubicacion" placeholder="Ubicación de la Vivienda" >
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.viviendaAnteriores_visita_ingreso.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_ingreso/vivienda_anterior_visita_ingreso.js"></script>
