    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">4. EVALUACIÓN DE LA ACTITUD Y COMPROMISO DEL EVALUADO CON EL PROCESO </h4>
            </div>
...
<?php include 'vw.dim_confiabilidad_compromiso_ver_academica.modal.php' ?>
<?php include 'vw.plantilla_var_ver_academica.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ver_academica/dim_confiabilidad_compromiso_ver_academica.js"></script>
