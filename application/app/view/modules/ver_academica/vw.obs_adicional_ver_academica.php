...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">5. REFERENCIAS PERSONALES Y OBSERVACIÓN ADICIONAL</h4>
            </div>
    ...
    <form id="formReferencias" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="telefono" class="control-label">Teléfono: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="telefono" id="telefono" placeholder="Ingrese el teléfono" required>
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.obs_adicional_ver_academica.modal.php' ?>
<?php include 'vw.observacion_ver_academica.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ver_academica/obs_adicional_ver_academica.js"></script>
