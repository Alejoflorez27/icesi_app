        ...
        <div class="modal-content">
            <form id="formFormacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-formacion">2. INFORMACIÓN, DOCUMENTACIÓN Y ANTECEDENTES ACADÉMICOS</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <!-- ENTRADA PARA EL NOMBRE DEL Evaluado -->
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="nom_funcionario_edit" class="control-label"> Nombre de quien verifica: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="tel_funcionario_edit" class="control-label"> Teléfono o correo de contacto: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                <input type="text" class="form-control" name="tel_funcionario_edit" id="tel_funcionario_edit" placeholder="Teléfono del Evaluado que verifica la información" >
                            </div>
                        </div>
                    </div>
