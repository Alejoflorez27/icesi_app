...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-6 center-block">
                <h4 class="box-title">6. CONCEPTO FINAL</h4>
            </div>
            <div class="col-xs-12 col-sm-6 center-block">
    ...
    <form id="formVivConceptoProfesional" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="observacion1" class="control-label">Observaciones Académica: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
...
<?php include 'vw.conceptoProfesional_ver_academica.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ver_academica/conceptoProfesional_ver_academica.js"></script>
