...
<div id="modalAddDimensionAcademico" class="modal fade" role="dialog" style="z-index: 9999;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formDimensionAcademicoedit" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-dimensionFamilia">3. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD DE INFORMACIÓN, DOCUMENTACIÓN Y ANTECEDENTES ACADÉMICOS</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="variableAcademicoEdit" class="control-label">Variable a Analizar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
								<select class="form-control input" id="variableAcademicoEdit" name="variableAcademicoEdit" required>
                                </select>
                            </div>
                        </div>
                    </div>
...
*Rol del Evaluado: único proveedor, puede ser un riesgo, que puede llevarlo a actos de robo. Como lo reconocen en su núcleo familiar. En la visita debe estar un familiar.</textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn-submit-dimensionEditAcademico" type="submit" class="btn btn-primary" data-dismiss="modal">Guardar</button>
                </div>
            </form>
        </div>
    </div>
