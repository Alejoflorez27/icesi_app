                    ...
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 center-block">
                                <h4 class="box-title">4. RELATO DE LOS HECHOS</h4>
                            </div>
                            ...
                            <form id="formObservacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <input type="hidden" id="id_relato" name="id_relato" value="">
                                <br><br><br>
                                <p>El dia, el señor(a) <?= $solicitud['nombre_candidato']?> identificado con C.C. <?= $solicitud['doc_candidato']?> se presentó voluntariamente a las instalaciones de la firma <?= $solicitud['cliente_desc']?> ,ubicada en <?= $solicitud['dir_cli']?> con el fin de que se le administrara un examen de polígrafia:</p>

                                <!-- ENTRADA PARA EL RESULTADO -->
                                <div class="col-xs-12 col-sm-12 center-block">
                                    <div class="form-group">
                                        <label for="relato" class="control-label"><br>Al entrevistar al evaluado sobre los hechos, este manifiesta textualmente lo siguiente:</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-toggle-on"></i></span>
                                            <textarea class="form-control input" style="height: 120px;"  id="relato" name="relato"></textarea>
                                        </div>
                                    </div>
                                </div>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_especifico/relato_pol_especifico.js"></script> 