        ...
        <div class="modal-content">
            <form id="formVivEgresos" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">7. EGRESOS MENSUALES DEL EVALUADO Y FAMILIA CON LA QUE CONVIVE</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <!--<select class="form-control input" id="tipo_familiar_egre_edit" name="tipo_familiar_egre_edit" required>
                                </select>-->
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="valor_egreso_edit" class="control-label">Valor aporte egreso ($): *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <input type="number" class="form-control input solo-mayuscula" name="valor_egreso_edit" id="valor_egreso_edit" placeholder="Valor de aporte al egreso" required>
                            </div>
                        </div>
                    </div>
