...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="solicitud/detalle?solicitud=<?= $solicitud['id_solicitud'] ?>"><i class="fa fa-dashboard"></i> Egresos del Evaluado y Familia</a></li>
        <li class="active">Pasivos del Evaluado y Familia</li>
    </ol>
</section>
<div class="row">
            ...
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-12 col-sm-8 center-block">
                        <h4 class="box-title">8. PASIVOS DEL EVALUADO Y FAMILIA CON LA QUE CONVIVE</h4>
                    </div>
    ...
    <div  class="col-xs-6 col-sm-6 center-block">
        <?php include 'vw.activos_pol_especifico.php' ?>
    </div>
...
<?php include 'vw.pasivos_pol_especifico.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_especifico/pasivos_pol_especifico.js"></script>
