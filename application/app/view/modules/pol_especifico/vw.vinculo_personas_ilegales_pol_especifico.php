                    ...
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 center-block">
                                <h4 class="box-title">6. Vínculos con grupos al margen de la ley</h4>
                            </div>
                            ...
                            <div class="div-Afisicos">
                                ...
                                <div class="col-xs-12 col-sm-12 center-block">
                                    <div class="form-group">
                                        <label for="respuesta" class="control-label">Ampliación Vinculos:</label>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_especifico/vinculo_personas_ilegales_pol_especifico.js"></script> 