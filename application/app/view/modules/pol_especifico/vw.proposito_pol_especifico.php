                    ...
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 center-block">
                                <h4 class="box-title">3. PROPÓSITO DEL EXAMEN</h4>
                            </div>
                            ...
                            <form id="formObservacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <input type="hidden" id="id_proposito" name="id_proposito" value="">

                                <!-- ENTRADA PARA EL RESULTADO -->
                                <div class="col-xs-12 col-sm-12 center-block">
                                    <div class="form-group">
                                        <label for="proposito" class="control-label"><br>¿Sabe usted por qué se encuentra hoy aquí?</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-toggle-on"></i></span>
                                            <textarea class="form-control input" style="height: 120px;"  id="proposito" name="proposito"></textarea>
                                        </div>
                                    </div>
                                </div>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_especifico/proposito_pol_especifico.js"></script> 