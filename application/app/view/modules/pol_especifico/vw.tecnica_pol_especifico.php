                    ...
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 center-block">
                                <h4 class="box-title">6. Técnica Poligráfia Empleada</h4>
                            </div>
                            ...
                            <form id="formObservacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="col-xs-12 col-sm-12 center-block">
                                    ...
                                    <p>El examen de polígrafo fue numéricamente evaluado por <?= $solicitud['resposable'] ?> quien fue asignado para realizar este examen.<br>
                                    <?= $solicitud['resposable'] ?> , es Poligrafista certificado y miembro de la Asociación Americana de Poligrafistas APA.
                                    </p>
                                    </div>
                                </div>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_especifico/tecnica_pol_especifico.js"></script> 