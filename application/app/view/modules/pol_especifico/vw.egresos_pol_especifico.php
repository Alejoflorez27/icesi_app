...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">7. EGRESOS MENSUALES FAMILIARES DEL EVALUADO Y FAMILIA CON LA QUE CONVIVE</h4>
            </div>
...
<?php include 'vw.egresos_pol_especifico.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_especifico/egresos_pol_especifico.js"></script>
