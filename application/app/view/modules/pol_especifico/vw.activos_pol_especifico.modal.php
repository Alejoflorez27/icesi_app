        ...
        <div class="modal-content">
            <form id="formVivActivos" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">9. ACTIVOS DEL EVALUADO Y FAMILIA CON LA QUE CONVIVE</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="concepto_activo_edit" class="control-label">Tipo Activos: *
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control input" id="concepto_activo_edit" name="concepto_activo_edit" required>
                                </select>
                            </div>
                        </div>
                    </div>
