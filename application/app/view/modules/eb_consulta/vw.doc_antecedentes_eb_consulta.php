...
<?php include 'vw.doc_antecedentes_eb_consulta.modal.php' ?>
<?php include 'vw.plantilla_var_eb_consulta.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/eb_consulta/doc_antecedentes_eb_consulta.js"></script>
