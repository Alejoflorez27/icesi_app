            ...
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 center-block">
                        <h4 class="box-title">4. Concepto Seguridad Física y Control de Acceso</h4>
                    </div>
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito" class="control-label">Concepto Seguridad Física y Control de Acceso: *</label>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito_completo" class="control-label">Concepto Seguridad Física y Control de Acceso Completo: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                            ...
                            <div class="modal-footer">
                                <button id="btn-submit-requisito" type="submit" class="btn btn-primary btnAddRequisito">Guardar</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.box-body -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            ...
                            <table id="tbl-requisito" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
...
<?php include 'vw.requisito_minimo_visita_asociado.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_asociado/requisito_minimo_visita_asociado.js"></script>
