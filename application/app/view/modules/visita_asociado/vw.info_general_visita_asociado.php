...
<div class="row">
    <div class="col-xs-6 col-sm-12 center-block">
        ...
        <div class="box box-primary">
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 center-block">
                        <h4 class="box-title">3. Concepto Legal</h4>
                    </div>
            ...
            <form id="formInfoAsociado" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                        <input type="hidden" id="accion" name="accion" value="">
                        <input type="hidden" id="id_info" name="id_info" value="">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito" class="control-label">Concepto Legal: *</label>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito_completo" class="control-label">Concepto Legal Completo: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <select class="form-control input" id="calificacion" name="calificacion" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="observacion" class="control-label">Observación o hallazgo: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                            ...
                            <div class="modal-footer">
                                <button id="btn-submit-info" type="submit" class="btn btn-primary btnAddInfo">Guardar</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.box-body -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            ...
                            <table id="tbl-info" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
...
<?php include 'vw.info_general_visita_asociado.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_asociado/info_general_visita_asociado.js"></script>
