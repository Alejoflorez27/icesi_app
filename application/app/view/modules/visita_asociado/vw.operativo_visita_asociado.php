    ...
    <div class="col-xs-6 col-sm-12 center-block">
        ...
        <div class="box box-primary">
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 center-block">
                        <h4 class="box-title">8. Concepto Operativo</h4>
                    </div>
            ...
            <form id="formOperativo" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <input type="hidden" id="id_operativo" name="id_operativo" value="">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito" class="control-label">Concepto Operativo: *</label>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito_completo" class="control-label">Concepto Operativo Completo: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
...
<?php include 'vw.operativo_visita_asociado.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_asociado/operativo_visita_asociado.js"></script>
