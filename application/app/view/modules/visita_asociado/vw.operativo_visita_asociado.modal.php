        ...
        <div class="modal-content">
            <form id="formOperativo" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">8. Concepto Operativo</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                            <div class="form-group">
                                <label for="requisito_edit" class="control-label">Concepto Operativo: *</label>
                        ...
                        <div class="col-xs-12 col-sm- center-block">
                            <div class="form-group">
                                <label for="requisito_completo_edit" class="control-label">Concepto Operativo: *</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
