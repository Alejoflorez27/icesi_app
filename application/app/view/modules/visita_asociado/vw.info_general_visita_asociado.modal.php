        ...
        <div class="modal-content">
            <form id="formInfoAsociado" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">3. Concepto Legal</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                            <div class="form-group">
                                <label for="requisito_edit" class="control-label">Concepto Legal: *</label>
                        ...
                        <div class="col-xs-12 col-sm- center-block">
                            <div class="form-group">
                                <label for="requisito_completo_edit" class="control-label">Concepto Legal Completo: *</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                        ...
                        <div class="col-xs-12 col-sm-6 center-block">
                            <div class="form-group">
                                <label for="observacion_edit" class="control-label">Observación o hallazgo: *</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn-submit-editInfo" type="submit" class="btn btn-primary" data-dismiss="modal">Guardar</button>
                </div>
            </form>
        </div>
    </div>
