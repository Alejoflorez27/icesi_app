...
<div class="row">
    <div class="col-xs-6 col-sm-12 center-block">
        ...
        <div class="box box-primary">
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 center-block">
                        <h4 class="box-title">6. Concepto Seguridad de Personal. Capacitación</h4>
                    </div>
            ...
            <form id="formEntrenamiento" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                        <input type="hidden" id="accion" name="accion" value="">
                        <input type="hidden" id="id_entrenamiento" name="id_entrenamiento" value="">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito" class="control-label">Concepto Seguridad de Personal. Capacitación: *</label>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    <label for="requisito_completo" class="control-label">Concepto Seguridad de Personal. Capacitación Completo: *</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                            ...
                            <div class="modal-footer">
                                <button id="btn-submit-entrenamiento" type="submit" class="btn btn-primary btnAddEntrenamiento">Guardar</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.box-body -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            ...
                            <table id="tbl-entrenamiento" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Concepto seguridad de Personal- Capacitacion</th>
                                        <th>Calificación</th>
                                        <th>Observación</th>
                                        <th>Acciones</th>
                                    </tr>
...
<?php include 'vw.entrenamiento_visita_asociado.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_asociado/entrenamiento_visita_asociado.js"></script>
