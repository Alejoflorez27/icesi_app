...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">9. ANÁLISIS DE REPORTE EN CENTRALES</h4>
            </div>
...
<?php include 'vw.financiero_pol_rutina.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/financiero_pol_rutina.js"></script>
