                            ...
                            <form id="formObservacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="col-xs-12 col-sm-12 center-block">
                                    ...
                                    <center>
                                        ...
                                        <h4>13. Vínculo con personas al margen de la ley</h4>
                                ...
                                <div class="div-AreaOculta">
                                <div class="div-Afisicos">
                                    <input type="hidden" id="idCaracteristica">
                                        <div class="box-body">
                                        <br><br>
                                        <label class="control-label">2. Con quien tiene vinculos:*</label>
                                ...
                                <div class="col-xs-12 col-sm-12 center-block">
                                    <div class="form-group">
                                        <label for="pregunta_cuatro" class="control-label">5. ¿Ha recibido usted algún beneficio, producto de actividades ilícitas?:</label>
                                        <div class="input-group">
                                ...
                                <div class="col-xs-12 col-sm-12 center-block">
                                    <div class="form-group">
                                        <label for="pregunta_cinco" class="control-label">6. Comentarios del examinador:</label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/vinculo_personas_ilegales_pol_rutina.js"></script> 