...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">5. EGRESOS MENSUALES DEL EVALUADO</h4>
            </div>
    ...
    <form id="formVivEgresos" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="otros" class="control-label">Concepto: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <!--<select class="form-control input select2" id="otros" name="otros" required>
                                </select>-->
                                <input type="text" class="form-control input" name="otros" id="otros" placeholder="Ingrese Concepto" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="valor_egreso" class="control-label">Valor egreso ($): *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <input type="number" class="form-control input solo-mayuscula" name="valor_egreso" id="valor_egreso" placeholder="Valor de egreso" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 center-block">
                            <h2><strong>Total Egresos:</strong></h2>
                        </div>
                        <div class="col-xs-12 col-sm-6 center-block">
...
<?php include 'vw.egresos_pol_rutina.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/egresos_pol_rutina.js"></script>
