...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">9. Empleo Actual</h4>
            </div>
    ...
    <form id="formLaboral" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-3 center-block">
                        <div class="form-group">
                            <label for="cargo_finalizo" class="control-label">Nombre del Cargo: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="funciones_desarrolladas" class="control-label">Funciones que desempeña:</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
...
<?php include 'vw.laboral_pol_rutina.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/laboral_pol_rutina.js"></script>
