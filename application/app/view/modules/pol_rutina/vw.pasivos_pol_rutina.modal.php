        ...
        <div class="modal-content">
            <form id="formVivPasivos" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">6. PASIVOS DEL EVALUADO</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="otrosEdit" class="control-label">Observación General: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <!--<select class="form-control input" id="otros" name="otros" required>
                                </select>-->
                                <textarea class="form-control input" style="height: 100px;" id="otrosEdit" name="otrosEdit"></textarea>
