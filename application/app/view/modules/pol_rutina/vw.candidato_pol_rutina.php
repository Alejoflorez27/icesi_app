...
<div class="box box-primary">
    ...
    <form id="formPoligrafiaPre" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="box-header" id="div-crear">
                    <h3 class="box-title">Datos Generales Poligrafía Rutina</h3>
                </div>
            ...
            <div class="box-body">
                    ...
                    La empresa <?= $solicitud['cliente_desc'] ?> solicita evaluación poligráfica con el propósito de determinar si <?= $solicitud['nombre_candidato'] ?> cumple con el perfil de confiabilidad en el cargo que actualmente se encuentra desempeñando como: <?= $solicitud['cargo'] ?>
                        <br>
                        <br>
                    </div>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/candidato_pol_rutina.js"></script>