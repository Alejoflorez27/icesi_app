    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">8. Nivel De Estudios- Último Grado Cursado</h4>
            </div>
...
<?php include 'vw.formacion_pol_rutina.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/formacion_pol_rutina.js"></script>
