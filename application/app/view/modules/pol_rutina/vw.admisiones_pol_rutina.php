                    ...
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 center-block">
                                <h4 class="box-title">17. ADMISIONES Y COMENTARIOS DE INTERES:</h4>
                            </div>
                            ...
                            <br><br><br><br>
                            <table id="tbl-admisiones" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Aria de Riesgo</th>
                                        <th>Admitio</th>
                                    </tr>
                                </thead>
                            </table>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/admisiones_pol_rutina.js"></script> 