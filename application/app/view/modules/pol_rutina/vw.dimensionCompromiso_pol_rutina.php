...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">18. ACTITUD Y COMPROMISO DEL EVALUADO CON EL PROCESO</h4>
            </div>
    ...
    <form id="formDimensionFinanciero" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="nivel_riesgo" class="control-label">Nivel de actitud identificada (si no se escribió nada, al guardar emitir un mensaje) : *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="respuesta" class="control-label">Observaciones: *
...
<?php include 'vw.dimensionCompromiso_pol_rutina.modal.php' ?>
<?php include 'vw.plantilla_var_pol_rutina.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/dimensionCompromiso_pol_rutina.js"></script>
