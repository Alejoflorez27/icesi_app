...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">15. LAS PREGUNTAS RELEVANTES FUERON LAS SIGUIENTES:</h4>
            </div>
...
<?php include 'vw.preguntas_relevantes_pol_rutina.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/preguntas_relevantes_pol_rutina.js"></script>
