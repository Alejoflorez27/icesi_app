                    ...
                    <div class="modal-header">
                        <div class="row">
                            ...
                            <center>
                                ...
                                <h4> &nbsp;&nbsp;&nbsp;&nbsp;12. Consumo de Alcohol y consumo sustancias alucinógenas</h4>
                                <br>
                            <!-- CONSUMO DE LICOR -->
                            <div class="div-Afisicos col-xs-12 col-sm-6 center-block">
                            ...
                            <form id="formObservacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <!-- ENTRADA PARA INFORME POR VARIABLE licor --> 
                                    <div class="col-xs-12 col-sm-6 center-block">
                                        <div class="form-group">
                                            <label for="respuesta_licor" class="control-label">Amplie información de preguntas anteriores:</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                                <textarea class="form-control input" id="respuesta_licor" name="respuesta_licor"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-2 form-group form-check">
                                        <br>
                                        <input type="checkbox" class="form-check-input" id="admitio_licor" name="admitio_licor" value="0">
                                        <label class="form-check-label" for="admitio_licor">El Evaluado Admite</label>
                                    </div>

                                    <!-- ENTRADA PARA INFORME POR VARIABLE licor --> 
                                    <div class="col-xs-12 col-sm-6 center-block" id="ocultar_licor">
                                        <div class="form-group">
                                            <label for="resumen_licor" class="control-label">Admisiones el evaluados:</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                                <textarea class="form-control input" id="resumen_licor" name="resumen_licor"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                            <!-- CONSUMO DE SUSTANCIAS ALUCINOGENAS -->
                            <div class="div-Avinculo col-xs-12 col-sm-6 center-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 center-block">
                                        <div class="form-group">
                                            <label for="respuesta" class="control-label">Amplie información de preguntas anteriores:</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                    ...
                                    <!-- ENTRADA PARA INFORME POR VARIABLE --> 
                                    <div class="col-xs-12 col-sm-6 center-block" id="ocultar">
                                        <div class="form-group">
...
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/preguntas_consumo_pol_rutina.js"></script> 