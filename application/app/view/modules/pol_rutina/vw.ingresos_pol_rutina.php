...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-12 center-block">
                <h4 class="box-title">4. INGRESOS MENSUALES DEL EVALUADO</h4>
            </div>
...
<section class="content">
    <div class="row">
     ...
     <div  class="col-xs-6 col-sm-6 center-block">
        <?php include 'vw.egresos_pol_rutina.php' ?>
    </div>
</div>

<?php include 'vw.ingresos_pol_rutina.modal.php' ?>
<?php include 'vw.ayuda_pol_rutina.modal.php' ?>
<?php include 'vw.ayuda1_pol_rutina.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_rutina/ingresos_pol_rutina.js"></script>
