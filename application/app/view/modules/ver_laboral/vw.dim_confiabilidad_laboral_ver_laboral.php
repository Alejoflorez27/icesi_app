    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">4. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD LABORAL DEL EVALUADO </h4>
            </div>
...
<?php include 'vw.dim_confiabilidad_laboral_ver_laboral.modal.php' ?>
<?php include 'vw.plantilla_var_ver_laboral.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ver_laboral/dim_confiabilidad_laboral_ver_laboral.js"></script>
