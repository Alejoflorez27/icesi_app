<div id="modalAddReferencia" class="modal fade" role="dialog" style="z-index: 9999;">
        ...
        <div class="modal-content">
            <form id="formReferencias" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-referencias"> 6. REFERENCIAS PERSONALES Y OBSERVACIÓN ADICIONAL</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="telefono_edit" class="control-label">teléfono: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="telefono_edit" id="telefono_edit" placeholder="Ingrese el teléfono" required>
                            </div>
                        </div>
                    </div>
