        ...
        <div class="modal-content">
            <form id="formLaboral" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-laboral">2. VERIFICACIÓN DE CONFIABILIDAD Y COHERENCIA DE LA INFORMACIÓN E HISTORIA LABORAL</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-3 center-block">
                        <div class="form-group">
                            <label for="nom_funcionario_valida_edit" class="control-label">Nombre de la persona que verifica la informacion: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="nom_funcionario_valida_edit" id="nom_funcionario_valida_edit" placeholder="Nombre del Evaluado">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-3 center-block">
                        <div class="form-group">
                            <label for="cargo_funcionario_valida_edit" class="control-label">Cargo / Área funcionario:</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="cargo_funcionario_valida_edit" id="cargo_funcionario_valida_edit" placeholder="Cargo del Funcionario">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-3 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <select class="form-control input" id="estado_empresa_edit" name="estado_empresa_edit" required>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <select class="form-control input" id="horario_trabajo_edit" name="horario_trabajo_edit" required>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="jefe_inmediato_edit" class="control-label">Nombre del jefe que valida la información: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="jefe_inmediato_edit" id="jefe_inmediato_edit" placeholder="Nombre del Jefe">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="cargo_jefe_edit" class="control-label">Cargo del jefe que valida la información:</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="cargo_jefe_edit" id="cargo_jefe_edit" placeholder="Cargo del Jefe">
                            </div>
                        </div>
                    </div>
