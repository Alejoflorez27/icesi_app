...
<div id="modalAddDimensionLaboral" class="modal fade" role="dialog" style="z-index: 9999;">
        ...
        <div class="modal-content">
            <form id="formDimensionLaboraledit" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-dimensionFamilia">4. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD LABORAL DEL EVALUADO</h4>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
								...
								<select class="form-control input" id="variableLaboralEdit" name="variableLaboralEdit" required>
                                </select>
                            </div>
                        </div>
                    </div>
