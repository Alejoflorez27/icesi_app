    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">2. VERIFICACIÓN DE CONFIABILIDAD Y COHERENCIA DE LA INFORMACIÓN E HISTORIA LABORAL</h4>
            </div>
    ...
    <form id="formLaboral" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                <div class="col-xs-12 col-sm-12 center-block">
                    ...
                    <!-- ENTRADA PARA EL NOMBRE DEL Evaluado QUE CONFIRMA LA INFORMACIÓN -->
                    <div class="col-xs-12 col-sm-3 center-block">
                        <div class="form-group">
                            <label for="nom_funcionario_valida" class="control-label">Nombre del funcionario que verifica la información: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="nom_funcionario_valida" id="nom_funcionario_valida" placeholder="Nombre del funcionario que verifica">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-3 center-block">
                        <div class="form-group">
                            <label for="cargo_funcionario_valida" class="control-label">Cargo / Área funcionario:</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="cargo_funcionario_valida" id="cargo_funcionario_valida" placeholder="Cargo del funcionario">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="jefe_inmediato" class="control-label">Nombre del jefe que valida la información:*</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="jefe_inmediato" id="jefe_inmediato" placeholder="Nombre del Jefe">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="cargo_jefe" class="control-label">Cargo del jefe que valida la información:</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="cargo_jefe" id="cargo_jefe" placeholder="Cargo del Jefe">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="concepto" class="control-label">Concepto:
                                <button class="btn btn-primary btnPlantillaLaboral" type="button" data-toggle="modal" data-target="#modalPlantillaLaboral">
                                    <i class="fa fa-info-circle"></i>
                                </button>
                            </label>
                            <div class="input-group">
                    ...
                    <table id="tbl-laboral" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Nombre del funcionario valida</th>
                                <th>Cargo / Área funcionario</th>
...
<?php include 'vw.laboral_ver_laboral.modal.php' ?>
<?php include 'vw.plantilla_var_ver_laboral_concepto.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ver_laboral/laboral_ver_laboral.js"></script>
