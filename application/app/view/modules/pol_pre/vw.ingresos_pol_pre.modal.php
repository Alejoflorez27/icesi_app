        ...
        <div class="modal-content">
            <form id="formVivIngresos" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">4. INGRESOS DEL EVALUADO</h4>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input" name="tipo_familiar_edit" id="tipo_familiar_edit" placeholder="Integrante" required>
                            </div>
                        </div>
                    </div> -->
