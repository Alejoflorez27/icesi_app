...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-6 center-block">
                <h4 class="box-title">3. COMPOSICIÓN FAMILIAR  (familiares o personas  con los que vive el evaluado)</h4>
            </div>
            <div class="col-xs-12 col-sm-6 center-block">
    ...
    <form id="formFamilia" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div style="color:red;" class="col-xs-12 col-sm-12 center-block">
...
<?php include 'vw.familia_pol_pre.modal.php' ?>
<?php include 'vw.observacion_pol_pre.modal.php' ?>
<?php include 'vw.info_ocu_familia_pol_pre.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/familia_pol_pre.js"></script>
