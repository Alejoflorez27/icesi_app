                            ...
                            <div class="div-Afisicos">
                                <input type="hidden" id="idCaracteristica">
                                    <div class="box-body">
                                        ...
                                        <h4>13. Consumo de Alcohol</h4>
                                        <h5>Por favor explique cada tema, antes de hacer las preguntas:</h5>
                                        <p>Consumir licor es una conducta socialmente aceptada, la mayoría de las personas lo han hecho en su vida.
                                        </p>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/consumo_alcohol_pol_pre.js"></script> 