...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">24. LAS PREGUNTAS RELEVANTES FUERON LAS SIGUIENTES:</h4>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <!-- Generar botones de radio para la escala del -15 al 15 -->
                                    <?php
                                    for ($i = -15; $i <= 15; $i++) {
            ...
            <div class="box-header with-border">
                ...
                <div class="box-body">
                    ...
                    <form id="formObservacion" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="col-xs-12 col-sm-12 center-block">
                            <div class="form-group">
                                <label for="respuesta" class="control-label">Resultado final del examen:</label>
                                <div class="input-group">
...
<?php include 'vw.preguntas_relevantes_pol_pre.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/preguntas_relevantes_pol_pre.js"></script>
