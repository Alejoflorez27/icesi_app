                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="col-xs-6 col-sm-12 center-block">
                            <h4 class="box-title">11. BRECHAS O INACTIVIDAD LABORAL</h4>
                        </div>
                    <div class="box-header with-border">
                    </div>
            ...
            <form id="formBrechas" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-9 center-block">
                                <p>1. Se encontrarón en la historia laboral del evaluado, brechas o tiempos laborales de inactividad superiores a 6 meses (Si la respuesta es SI, escriba en la casillas que se activaran, cuáles fueron las brechas o periodos de inactividad encontrados, los tiempos aproximados y las fechas aproximadas?</p>
                            </div>
...
<?php include 'vw.brechas_laboral_pol_pre.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/brechas_laboral_pol_pre.js"></script>
