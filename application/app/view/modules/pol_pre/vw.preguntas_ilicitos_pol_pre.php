                            ...
                            <div class="div-Afisicos">
                                ...
                                <input type="hidden" id="id_empresa" value="<?= $solicitud['id_empresa'] ?>">
                                    <div class="box-body">
                                        ...
                                        <h4>12. ILÍCITOS EN EMPLEOS</h4>
                                        <h5>Por favor explique cada tema, antes de hacer las preguntas:</h5>
                                        <h5>Conductas Laborales Anteriores</h5>
                                        <p>Los empleadores generalmente son realistas respecto de que algunas conductas sucedan dentro de sus 
                                            organizaciones, lo importante es poder valorar su sinceridad respecto de las situaciones que pudieron
                                             ocurrir en sus empleos anteriores, entenderlas y explicarlas si admite alguna o varias conductas, 
                                             al final contará con un espacio para que pueda explicar las circunstancias de por qué sucedieron. 
                                             Le animamos a ser sincero y de esta forma evitar reaccionar en la sesión que tendrá validación 
                                             fisiológica. La mayoría de candidatos admiten mas de una conducta de las que se le preguntaran a 
                                             continuación:
                                        </p>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/preguntas_ilicitos_pol_pre.js"></script> 