...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">5. EGRESOS DEL EVALUADO</h4>
            </div>
...
<?php include 'vw.egresos_pol_pre.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/egresos_pol_pre.js"></script>
