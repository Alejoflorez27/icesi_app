        ...
        <div class="modal-content">
            <form id="formVivEgresos" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">5. EGRESOS DEL EVALUADO</h4>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input" name="otrosEdit" id="otrosEdit" placeholder="Ingrese Concepto" required>
                            </div>
                        </div>
                    </div>
