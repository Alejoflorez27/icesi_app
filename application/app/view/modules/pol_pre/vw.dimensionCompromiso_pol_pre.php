...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">27. ACTITUD Y COMPROMISO DEL EVALUADO CON EL PROCESO</h4>
            </div>
...
<?php include 'vw.dimensionCompromiso_pol_pre.modal.php' ?>
<?php include 'vw.plantilla_var_pol_pre.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/dimensionCompromiso_pol_pre.js"></script>
