                            ...
                            <div class="col-xs-12 col-sm-4 center-block">
                                ...
                                <input type="hidden" id="idCaracteristica">
                                    <div class="box-body">
                                        ...
                                        <h4>21. Infiltración</h4>
                                        <h5>Por favor explique cada tema, antes de hacer las preguntas:</h5>
                                        <p>Hace referencia a tener un plan estructurado para ingresar a la compañía para cometer actos en contra de la misma. <br>
                                        Algunos ejemplos del propósito podría incluir pero no se limita a <br>

                                        1. Suministrar información confidencial de la empresa a personas no autorizadas y con propósitos ilícitos. <br>
                                        2. Entregar información de la compañía a la competencia. <br>
                                        3. Realizar actividades de sabotaje. <br>
                                        4. Afectar en alguna forma a superiores, subalternos o compañeros de trabajo. <br>
                                        5. Brindar información de directivos para facilitar la comisión de delitos como secuestro y extorsión. <br>
                                        6. Buscar vulnerabilidades en los procesos para usarlas en contra de la empresa pueden ser procesos de información o instalaciones físicas, procedimientos o similares. <br>
                                        Este plan se puede haber dado en asociación con otras personas o por iniciativa propia Puede existir o no una oferta económica o de cualquier tipo de beneficio para cometer estos actos si se obtiene el trabajo. El plan puede haber sido establecido con anterioridad al inicio del proceso de selección o haberse estructurado durante la realización del mismo.
                                        <br><br>
                                        </p>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/infiltracion_pol_pre.js"></script> 