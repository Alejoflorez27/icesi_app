...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">8. ANÁLISIS DE REPORTE EN CENTRALES</h4>
            </div>
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <select class="form-control input" id="concepto_financiero" name="concepto_financiero" required>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.financiero_pol_pre.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/financiero_pol_pre.js"></script>
