...
<div class="box box-primary">
    ...
    <form id="formPoligrafiaPre" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="box-header" id="div-crear">
                    <h3 class="box-title">1. Datos Generales Poligrafía Pre-Empleo</h3>
                </div>
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control input" name="email1" id="email1" placeholder="Ingrese el Correo del Evaluado" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control input" name="email2" id="email2" placeholder="Ingrese el Correo del Evaluado" required>
                            </div>
                        </div>
                    </div>
...
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/candidato_pol_pre.js"></script>