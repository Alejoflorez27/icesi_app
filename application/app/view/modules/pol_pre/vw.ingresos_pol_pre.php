...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-12 center-block">
                <h4 class="box-title">4. INGRESOS DEL EVALUADO</h4>
            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input" name="tipo_familiar" id="tipo_familiar" placeholder="Integrante" required>
                            </div>
                        </div>
                    </div> -->
...
<section class="content">
    <div class="row">
     ...
     <div  class="col-xs-6 col-sm-6 center-block">
        <?php include 'vw.egresos_pol_pre.php' ?>
    </div>
</div>

<?php include 'vw.ingresos_pol_pre.modal.php' ?>
<?php include 'vw.ayuda_pol_pre.modal.php' ?>
<?php include 'vw.ayuda1_pol_pre.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/pol_pre/ingresos_pol_pre.js"></script>
