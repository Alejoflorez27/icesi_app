        ...
        <div class="modal-content">
            <form id="formPreguntas" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-distribucion">24. LAS PREGUNTAS RELEVANTES FUERON LAS SIGUIENTES:</h4>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control input" id="tipo_rn_edit" name="tipo_rn_edit" disabled>
                                </select>
                            </div>
                        </div>
                    </div>
