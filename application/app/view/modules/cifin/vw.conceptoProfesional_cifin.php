    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-6 center-block">
                <h4 class="box-title">4. CONCEPTO FINAL</h4>
            </div>
            <div class="col-xs-12 col-sm-6 center-block">
...
<?php include 'vw.conceptoProfesional_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/cifin/conceptoProfesional_cifin.js"></script>
