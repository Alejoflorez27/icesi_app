    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">3. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD FINANCIERA/CIFIN - CRÉDITOS Y OBLIGACIONES FINANCIERAS</h4>
            </div>
...
<?php include 'vw.dim_confiabilidad_fin_cifin.modal.php' ?>
<?php include 'vw.plantilla_var_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/cifin/dim_confiabilidad_fin_cifin.js"></script>
