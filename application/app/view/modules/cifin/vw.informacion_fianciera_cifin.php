...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">2. CONFIABILIDAD FINANCIERA/CIFIN - CRÉDITOS Y OBLIGACIONES FINANCIERAS</h4>
            </div>
...
<?php include 'vw.informacion_fianciera_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/cifin/informacion_financiera_cifin.js"></script>
