    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formDimensionFamiliaedit" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" id="id_dimension" name="id_dimension" value="1">

                <div class="modal-header" id="div-crear">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" id="titulo-modal-dimensionFamilia">3. EVALUACIÓN DEL NIVEL DE CONFIABILIDAD FINANCIERA/CIFIN - CRÉDITOS Y OBLIGACIONES FINANCIERAS</h4>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
								...
								<select class="form-control input" id="variableFamiliaEdit" name="variableFamiliaEdit" required>
                                </select>
                            </div>
                        </div>
                    </div>
