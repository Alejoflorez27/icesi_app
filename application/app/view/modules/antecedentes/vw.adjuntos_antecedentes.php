...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">4.Cargue Adjuntos</h4>
            </div>
    ...
    <form id="frmCargarArchivo" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-7">
                        ...
                        <input id="archivoAlt" name="archivo_alt[]" type="file" multiple style="display: none;" accept=".jpg, .png, .pdf" />
...
<script src="<?= constant('APP_URL') ?>app/js/antecedentes/adjuntos_antecedentes.js"></script>
