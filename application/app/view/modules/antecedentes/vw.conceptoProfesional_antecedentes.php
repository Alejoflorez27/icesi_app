    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-6 center-block">
                <h4 class="box-title">3. CONCEPTO FINAL</h4>
            </div>
            <div class="col-xs-12 col-sm-6 center-block">
...
<?php include 'vw.conceptoProfesional_antecedentes.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/antecedentes/conceptoProfesional_antecedentes.js"></script>
