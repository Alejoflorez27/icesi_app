            ...
            <div class="col-xs-12 col-sm-12 center-block" id="contenedor" name="contenedor"> 
                    ...
                    <div class="d-inline" name="c_seleccion" id="c_seleccion" style="display: inline;">
                            ...
                            <div class="d-inline">
                                ...
                                <select class="form-control input select2" id="p_seleccion" name="p_seleccion" style="display: inline;" required>
...
<?php include 'vw.doc_antecedentes_antecedentes.modal.php' ?>
