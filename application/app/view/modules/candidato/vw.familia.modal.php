        ...
        <div class="modal-content">
            <form id="formFamilia" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-familia">Formación Academica</h4>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="nombre_edit" class="control-label">Nombres del Familiar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-font"></i></span>
                                <input type="text" class="form-control input" name="nombre_edit" id="nombre_edit" placeholder="Lugar del Familiar" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="apellido_edit" class="control-label">Apellidos del Familiar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-font"></i></span>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="telefono_edit" class="control-label">Número Contacto Familiar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control input solo-mayuscula" name="telefono_edit" id="telefono_edit" placeholder="Número del Familiar" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="ocupacion_edit" class="control-label">Ocupación del Familiar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                <input type="text" class="form-control input" name="ocupacion_edit" id="ocupacion_edit" placeholder="Ocupacion del Familiar" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="residencia_edit" id="residencia_edit" placeholder="Lugar de Residencia" required>
                            </div>
                        </div>
                    </div>
