        ...
        <div class="modal-content">
            <form id="formLaboral" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="telefono_empresa_edit" class="control-label">Teléfono de la Empresa: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control input" name="telefono_empresa_edit" id="telefono_empresa_edit" placeholder="Ingrese el Teléfono de la Empresa" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="fch_ingreso_edit" class="control-label">Fecha de Ingreso a la Empresa: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                <input type="date" class="form-control" name="fch_ingreso_edit" id="fch_ingreso_edit" placeholder="Ingrese Fecha de Ingreso de Empresa" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-cc"></i></span>
                                <input type="date" class="form-control" name="fch_retiro_edit" id="fch_retiro_edit" placeholder="Ingrese Fecha de Retiro de Empresa" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="cargo_ingreso_edit" id="cargo_ingreso_edit" placeholder="Cargo al que Ingreso el Evaluado" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="cargo_finalizo_edit" class="control-label">Cargo en el que Finalizó: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="cargo_finalizo_edit" id="cargo_finalizo_edit" placeholder="Cargo en el que Finalizó el Evaluado" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="jefe_inmediato_edit" id="jefe_inmediato_edit" placeholder="Ingrese el Nombre del Jefe Inmediato" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="cargo_jefe_edit" id="cargo_jefe_edit" placeholder="Ingrese el Cargo del Jefe Inmediato" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control input" name="numero_jefe_edit" id="numero_jefe_edit" placeholder="Ingrese el Número del Jefe Inmediato" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="funciones_desarrolladas_edit" id="funciones_desarrolladas_edit" placeholder="Ingrese las Funciones Desarrolladas" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input solo-mayuscula" name="motivo_retiro_edit" id="motivo_retiro_edit" placeholder="Ingrese el Motivo Retiro" required>
                            </div>
                        </div>
                    </div>-->
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="tipo_retiro_edit" class="control-label">Motivo Retiro: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
