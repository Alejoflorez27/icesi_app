    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">12. PASIVOS DEL EVALUADO (CONYUGUE SI APLICA Y DEUDAS EN COMUN)</h4>
            </div>
...
<section class="content">
    ...
    <div  class="col-md-6 col-12">
        <?php include 'vw.activos_visita_mantenimiento.php' ?>
    </div>
...
<?php include 'vw.pasivos_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/pasivos_visita_mantenimiento.js"></script>
