...
<div class="box box-primary">
    ...
    <form id="formVisitaMantenimiento" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="box-header" id="div-crear">
                    <h3 class="box-title">Datos Generales Visita Domiciliaria Mantenimiento</h3>
                </div>
            ...
            <div class="box-body">
                    ...
                    <!-- <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control input solo-mayuscula" name="emali2" id="emali2" placeholder="Ingrese el Correo del Evaluado" required>
                            </div>
                        </div>
                    </div>-->
                    <!-- ENTRADA PARA SALARIO ACTUAL-->
                    <div class="col-xs-12 col-sm-3 center-block">
                        <div class="form-group">
                            <label for="salario_actual" class="control-label">Salario Actual: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control input" name="salario_actual" id="salario_actual" placeholder="Ingrese Salario Actual" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-hashtag"></i></span>
                                <input type="number" class="form-control input solo-mayuscula" name="estracto" id="estracto"  required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="cargo_desempeno" class="control-label">Cargo inicial / Cargo que desempeña: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input" name="parantesco_visita" id="parantesco_visita" placeholder="Parentesco con el Candidato" required>
                            </div>
                        </div>
                    </div>
                    <div style="color:red;">
                    ...
                    <div class="modal-footer">
                        <button id="btn-submit-funcionario" type="submit" class="btn btn-primary btnEditFuncionario">Guardar</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
...
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/funcionario_visita_mantenimiento.js"></script>
