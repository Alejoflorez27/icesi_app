...
<div class="box box-primary">
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">8. SITIOS DE VIVIENDA ANTERIORES Y TIEMPO DE ESTADÍA EN ESTOS <br>(Solo si ha tenido cambios de vivienda desde la última visita realizada)
</h4>
            </div>
    ...
    <form id="formVivAnterior" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input" name="ubicacion" id="ubicacion" placeholder="Ingrese la Ubicación de la Vivienda" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="Tiempo_estadia" class="control-label">Tiempo en el que reside en la vivienda actual (Arraigo): *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <select class="form-control input select2" id="Tiempo_estadia" name="Tiempo_estadia" placeholder="Nivel de Escolaridad" required>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="motivo_cambio" class="control-label">Motivo de Cambio: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
                                <input type="text" class="form-control input" name="motivo_cambio" id="motivo_cambio" placeholder="Ingrese el Motivo del cambio de la vivienda" >
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
                ...
                <div class="box-body">
                    <table id="tbl-vivAnteriores" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Ubicación</th>
...
<?php include 'vw.viviendaAnteriores_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/vivienda_anterior_visita_mantenimiento.js"></script>
