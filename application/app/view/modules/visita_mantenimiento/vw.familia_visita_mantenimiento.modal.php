                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
								...
								<!--<select class="form-control input" id="parentesco_edit" name="parentesco_edit" placeholder="Parentesco Candidato" required>
                                </select>-->
                                <input type="text" class="form-control input" name="parentesco_edit" id="parentesco_edit" placeholder="Parentesco con el candidato" required>
                            </div>
                        </div>
                    </div>
