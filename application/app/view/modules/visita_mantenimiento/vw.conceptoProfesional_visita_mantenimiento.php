    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-6 center-block">
                <h4 class="box-title">19. CONCEPTO PROFESIONAL</h4>
            </div>
            <div class="col-xs-12 col-sm-6 center-block">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="expectativas" class="control-label">Sugerencias o recomendaciones frente a la empresa y el cargo: *</label>
...
<?php include 'vw.dimConcepto_visita_mantenimiento.modal.php' ?>
<?php include 'vw.ayuda_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/conceptoProfesional_visita_mantenimiento.js"></script>
