...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">17.MATRIZ VALORACION DE LA ACTITUD Y COMPROMISO DEL EVALUADO CON EL PROCESO</h4>
            </div>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="small-box bg-aqua text-center">
                        ...
                        <p style="font-size: 14px">En la variable analizada el evaluadono evidencia riesgo en la actitud y colaboración con la visita
                        </p>
                        </div>
...
Que el evaluado o candidato, muestre poco interés frente al proceso, que no suministre información necesaria
...
<?php include 'vw.dimensionCompromiso_visita_mantenimiento.modal.php' ?>
<?php include 'vw.plantilla_var_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/dimensionCompromiso_visita_mantenimiento.js"></script>
