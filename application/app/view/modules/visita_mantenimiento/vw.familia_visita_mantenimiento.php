...
<div class="box box-primary">
    ...
    <form id="formFamilia" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
								...
								<!--<select class="form-control input select2" id="parentesco" name="parentesco" placeholder="Parentesco Candidato" required>
                                </select>-->
                    ...
                    <!-- ENTRADA PARA VIVE CON EL CANDIDATO -->
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                    ...
                    <!-- ENTRADA DEPENDE ECONOMICAMENTE DEL CANDIDATO -->
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
...
<?php include 'vw.familia_visita_mantenimiento.modal.php' ?>
<?php include 'vw.observacion_visita_mantenimiento.modal.php' ?>
<?php include 'vw.info_ocu_familia_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/familia_visita_mantenimiento.js"></script>
