            ...
            <div class="modal-header">
                <div class="row">
                    <div class="col-xs-12 col-sm-8 center-block">
                        <h4 class="box-title">4. CARACTERISTICAS DE LA VIVIENDA</h4>
                    </div>
                ...
                <div class="box-header with-border">
                    ...
                    <button class="btn btn-primary btnAddCaracterisiticaViv" data-toggle="modal" data-target="#modalAddVivCaracteristica">
                        Crear Caracteristicas de la Vivienda
                    </button>
                    ...
                    <table id="tbl-vivCaracteristica" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Aclaraciones de caracteristics de la vivienda</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                    </table>
...
<?php include 'vw.caracteristicaVivienda_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/caracteristicas_vivienda_visita_mantenimiento.js"></script> 