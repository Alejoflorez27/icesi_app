    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-6 center-block">
                <h4 class="box-title">18.PROTOCOLO DE SEGURIDAD /ASPECTOS CRÍTICOS DE RIESGO</h4>
            </div>
            <div class="col-xs-12 col-sm-6 center-block">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="concepto_seguridad" class="control-label">Aspecto consultado al Evaluado y la familia con la que convive: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <select class="form-control input select2" id="concepto_seguridad" name="concepto_seguridad" required>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="concepto_seguridad_completo" class="control-label">Aspecto completo consultado al Evaluado y la familia con la que convive:</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <textarea class="form-control input" id="concepto_seguridad_completo" name="concepto_seguridad_completo" placeholder="Descripción completa de aspecto consultado" readonly=»readonly></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="respuesta" class="control-label">Estado: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <select class="form-control input select2" id="respuesta" name="respuesta" required>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="descripcion_seguridad" class="control-label">Observaciones: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <textarea class="form-control input" id="descripcion_seguridad" name="descripcion_seguridad" placeholder="Descripción"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button id="btn-submit-vivProtocoloSeguridad" type="submit" class="btn btn-primary btnAddVivFinanciero">Guardar</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
                ...
                <div class="box-body">
                    <table id="tbl-vivProtocoloSeguridad" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Aspecto de Riesgo</th>
                                <th>Respuesta SI/NO</th>
                                <th>Observaciones (Profundizar Cuando la Respuesta es Afirmativa)</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                    </table>
...
<?php include 'vw.protocoloSeguridad_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/protocoloSeguridad_visita_mantenimiento.js"></script>
