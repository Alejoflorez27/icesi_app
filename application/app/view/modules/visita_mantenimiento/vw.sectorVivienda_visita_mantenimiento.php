    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">7. CARACTERISTICAS DEL SECTOR</h4>
            </div>
...
<?php include 'vw.sectorVivienda_visita_mantenimiento.modal.php' ?>
<?php include 'vw.ayuda_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/caracteristicas_sector_visita_mantenimiento.js"></script> 