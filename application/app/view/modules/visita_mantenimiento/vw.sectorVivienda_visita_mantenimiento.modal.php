...
educativas, centros comerciales, centros de salud, etc): *</label>
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            <label for="vias_principales" class="control-label">Principales Vías de Acceso y Estado de las vías:(Realizar una descripción genérica de las vías de acceso al espacio habitacional del Evaluado) *
