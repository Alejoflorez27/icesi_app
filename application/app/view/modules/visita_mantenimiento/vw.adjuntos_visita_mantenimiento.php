...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">20.Cargue Adjuntos Visita Domiciliaria Mantenimiento</h4>
            </div>
...
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/adjuntos_visita_mantenimiento.js"></script>
