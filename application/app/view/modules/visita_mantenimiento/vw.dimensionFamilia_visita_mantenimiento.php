    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">3.MATRIZ VALORACIÓN DEL NIVEL DE RIESGO DE LA DIMENSION FAMILIAR DEL EVALUADO</h4>
            </div>
            ...
            <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="small-box bg-aqua text-center">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el Evaluado no evidencia riesgo en su comportamiento y contexto familiar.
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el Evaluado evidencia un bajo riesgo en su comportamiento y contexto familiar.
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el Evaluado evidencia un nivel medio de riesgo en su comportamiento y contexto familiar.
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el Evaluado evidencia un nivel alto de riesgo en su comportamiento y contexto familiar.
                                    </p>
                                    </div>
...
*Separaciones del candidato o evaluado y su responsabilidad con sus obligaciones. (Demandas de alimentos).
*Candidato, que no asume sus dificultades y las evade o  no participan en la solución de las mismas.
...
*Rol del candidato: único proveedor, puede ser un riesgo, que puede llevarlo a actos de robo. Como lo reconocen en su núcleo familiar. En la visita debe estar un familiar.</textarea>
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.dimensionFamilia_visita_mantenimiento.modal.php' ?>
<?php include 'vw.plantilla_var_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/dimensionFamilia_visita_mantenimiento.js"></script>
