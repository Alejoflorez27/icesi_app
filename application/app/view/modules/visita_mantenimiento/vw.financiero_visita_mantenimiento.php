...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">14. ANÁLISIS DE REPORTE EN CENTRALES</h4>
            </div>
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <textarea class="form-control input" id="descripcion_financiero" name="descripcion_financiero" placeholder="Descripción"></textarea>
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.financiero_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/financiero_visita_mantenimiento.js"></script>
