...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">13. ACTIVOS DEL EVALUADO (Y CONYUGUE)</h4>
            </div>
    ...
    <form id="formVivActivos" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block" id="ocultarAct">
                        <div class="form-group">
                            <label for="otrosAct" class="control-label"></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                    ...
                    <table id="tbl-vivActivos" class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Valor del Activo Comercial</th>
                                <th>Valor del Activo Catastral</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                    </table>
...
<?php include 'vw.activos_visita_mantenimiento.modal.php' ?>
<?php include 'vw.ayuda_visita_mantenimiento.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/activos_visita_mantenimiento.js"></script>
