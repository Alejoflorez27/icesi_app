...
<!--<section class="content-header">
    <h1>Candidato <strong><?= $solicitud['nombre_candidato']." ".$solicitud['doc_candidato'] ?></strong></h1>
    <ol class="breadcrumb">
    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">6. MOBILIARIO y ELECTRODOMÉSTICOS DE LA VIVIENDA</h4>
            </div>
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <select class="form-control input" id="estado_mobiliario" name="estado_mobiliario" required>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <select class="form-control input" id="tenencia_mobiliario" name="tenencia_mobiliario" required>
                                </select>
                            </div>
                        </div>
                    </div>
...
<script src="<?= constant('APP_URL') ?>app/js/visita_mantenimiento/mobiliario_vivienda_visita_mantenimiento.js"></script>
