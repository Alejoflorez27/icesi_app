        ...
        <div class="modal-content">
            <form id="formDimensionFinancieroedit" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-dimensionFamilia">Dimension Financiero</h4>
                </div>
                ...
                <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="small-box bg-aqua text-center">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el candidato evidencia un nivel
                                            muy bajo de riesgo financiero y económico
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el candidato evidencia un nivel
                                            bajo de riesgo financiero y económico
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el candidato evidencia un nivel
                                            medio de riesgo financiero y económico
                                    </p>
                                    </div>
                                ...
                                <div class="inner">
                                    ...
                                    <p style="font-size: 14px">En la variable analizada el candidato evidencia un nivel
                                            alto de riesgo financiero y económico
                                    </p>
                                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 center-block">
                        <div class="form-group">
                            <label for="variableSaludEdit" class="control-label">Variable a Analizar: *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-briefcase"></i></span>
								<select class="form-control input" id="variableSaludEdit" name="variableSaludEdit" required>
                                </select>
                            </div>
                        </div>
                    </div>
