...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="solicitud/detalle?solicitud=<?= $solicitud['id_solicitud'] ?>"><i class="fa fa-dashboard"></i> Evaluación de actitud y compromiso</a></li>
    ...
    <div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">11.REFERENCIAS PERSONALES Y OBSERVACIÓN ADICIONAL</h4>
            </div>
...
<?php include 'vw.obs_adicional_ec_con_cifin.modal.php' ?>
<?php include 'vw.observacion__ec_con_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_con_cifin/obs_adicional_ec_con_cifin.js"></script>
