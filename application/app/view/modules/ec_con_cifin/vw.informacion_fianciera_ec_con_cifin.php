...
<div class="modal-header">
    ...
    <form id="formInfoFinanciera" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12 col-sm-4 center-block">
                        <div class="form-group">
                            <label for="pago_minimo" class="control-label">Pago minimo mensual($): *</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                <input type="number" class="form-control input solo-mayuscula" name="pago_minimo" id="pago_minimo" placeholder="Pago minimo mensual" required>
                            </div>
                        </div>
                    </div>
...
<?php include 'vw.informacion_fianciera_ec_con_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_con_cifin/informacion_financiera_ec_con_cifin.js"></script>
