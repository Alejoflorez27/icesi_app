...
<div id="modalAddDimensionCompromiso" class="modal fade" role="dialog">
                    ...
                    <div class="col-xs-12 col-sm-12 center-block">
                        <div class="form-group">
                            ...
                            <div class="input-group">
								...
								<select class="form-control input select2" id="variableCompromisoEdit" name="variableCompromisoEdit" required>
                                </select>
                            </div>
                        </div>
                    </div>
