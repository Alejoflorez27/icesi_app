<div id="modalEditLaboralPeriodo" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            <form id="formLaboralPeriodo" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal">Distribución de la Vivienda</h4>
                </div>
                ...
                <div class="modal-body">
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control input select2" id="periodo_edit" name="periodo_edit" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 center-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-id-card"></i></span>
                                        <select class="form-control input select2" id="tmp_periodo_edit" name="tmp_periodo_edit" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
