...
<?php include 'vw.dim_confiabilidad_aca_ec_con_cifin.modal.php' ?>
<?php include 'vw.plantilla_var_ec_con_cifin.modal.php' ?>
<script src="<?= constant('APP_URL') ?>app/js/ec_con_cifin/dim_confiabilidad_aca_ec_con_cifin.js"></script>
