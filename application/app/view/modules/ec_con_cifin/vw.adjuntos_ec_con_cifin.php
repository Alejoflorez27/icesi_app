...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Cargue Adjuntos Estudio de Confidencialidad con Cifin</li>
    </ol>
</section>
...
<div class="modal-header">
        <div class="row">
            <div class="col-xs-12 col-sm-8 center-block">
                <h4 class="box-title">13.Cargue Adjuntos Estudio de Confidencialidad con Cifin</h4>
            </div>
...
<script src="<?= constant('APP_URL') ?>app/js/ec_con_cifin/adjuntos_ec_con_cifin.js"></script>
