    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formComboCliente" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" id="id_empresa_ser" name="id_empresa_ser" value="">
                ...
                <div class="modal-header" id="div-crear">
                    ...
                    <h4 class="modal-title" id="titulo-modal-comboCli">Combo Cliente</h4>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 center-block">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control input select2" id="id_combo" name="id_combo" required>
                                    </select>
                                </div>
                            </div>
                        </div>
