    ...
    $('#btn-submit-formacionn').on('click', function (e) {
        ...
        if(validateFormFormacionEdit()){
            ...
            $.ajax({
                ...
                url: url_site(`api/formacion/update_formacion?id_formacion=${data.id_formacion}&id_servicio=${id_servicioC}`), //Se le da el id_candidato de la data
                contentType: 'application/json',
                data: JSON.stringify(data),
                dataType: "json",
...
function cargarTablaFormacion() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: url_site(`api/formacion/lista_visitas?id_solicitud=${id_solicitudl}`),
        dataType: "json",
        success: function (r) {
            console.log(r);
