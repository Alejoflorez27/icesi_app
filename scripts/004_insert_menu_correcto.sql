-- ============================================================================
-- SCRIPT DE INSERCIÓN DE MENÚ - GESTIÓN CURRICULAR (VERSIÓN CORREGIDA)
-- ============================================================================
...
-- Guardar el ID del menú principal
...
-- VERIFICAR INSERCIÓN
-- ============================================================================
-- SELECT id, etiqueta, padre FROM usr_menu WHERE etiqueta IN ('Gestión Curricular', 'Dashboard', 'Cursos', 'Competencias', 'Objetivos', 'Análisis') ORDER BY id;
